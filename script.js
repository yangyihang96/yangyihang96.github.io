...
const translations = {
  en: {
    ...
    text: {
      ...
      ".hero-meta div:nth-child(4) dt": "Work checks",
      ".hero-meta div:nth-child(4) dd": "Private proof after fit",
  ...
  zh: {
    ...
    text: {
      ...
      ".hero-meta div:nth-child(4) dt": "核验",
      ".hero-meta div:nth-child(4) dd": "匹配后私下提供",
