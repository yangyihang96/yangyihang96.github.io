...
const translations = {
  en: {
    ...
    text: {
      ...
      ".hero-meta div:nth-child(4) dd": "Formal check ready",
      ...
      ".case-action": "View De-identified Cases",
      ...
      ".fit-strip .section-kicker": "Quick Fit",
      "#fit-title": "What a recruiter needs to know in the first 20 seconds.",
      ...
      ".fit-grid article:nth-child(4) span": "Work rights",
      ".fit-grid article:nth-child(4) strong": "Work-right check ready for formal process",
      ...
      ".case-grid article:nth-child(2) h3": "Turning user feedback into a tested service decision",
      ".case-grid article:nth-child(2) p":
        "Reported faults are split into symptom, use condition, service history, and reproducible path before manual-led checks and post-repair confirmation.",
      ...
      ".study-grid article:nth-child(1) span": "2024",
      ...
      ".contact-readiness div:nth-child(3) span": "Formal check ready",
    ...
    attrs: {
      ...
      ".case-action": { "aria-label": "View de-identified service cases" },
  ...
  zh: {
    ...
    text: {
      ...
      ".hero-meta div:nth-child(4) dd": "正式流程可核验",
      ...
      ".fit-strip .section-kicker": "快速匹配",
      "#fit-title": "招聘方前 20 秒最需要看到的信息。",
      ".fit-strip .section-intro":
      ...
      ".fit-grid article:nth-child(4) span": "工作权利",
      ".fit-grid article:nth-child(4) strong": "正式流程可核验",
      ...
      ".case-grid article:nth-child(2) h3": "把用户反馈变成可测试的服务判断",
      ".case-grid article:nth-child(2) p":
        "先拆分故障现象、使用条件、服务历史和可复现路径，再按手册检查并做维修后确认。",
      ...
      ".case-grid article:nth-child(3) .case-outcome dd:nth-of-type(5)":
        "通过在 Simpro 中对齐服务动作、测试记录、设备历史和客户更新，减少重复排查时间",
      ...
      ".contact-readiness div:nth-child(3) span": "正式流程可核验",
    ...
    attrs: {
      ...
      ".case-action": { "aria-label": "查看匿名服务案例" },
